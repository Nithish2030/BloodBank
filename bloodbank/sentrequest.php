...
<body>
	...
	<table class="table table-responsive table-striped rounded mb-5">
		<tr><th colspan="8" style="color:blue;font-size:25px">Sent requests</th></tr>
		<tr>
			<th>#</th>
			<th>Name</th>
			<th>Email</th>
		    ...
		    <div>
                ...
                }else echo '<b style="color:blue;padding:7px;font-size:15px">You have not requested yet. </b>';
            }
            ?>
            </div>
		...
		<tr>
			...
			<?php }
				...
				<a href="file/cancel.php?reqid=<?php echo $row['reqid'];?>" ">Cancel</a>
			<?php } ?>
			</td>
		</tr>
		<?php } ?>
